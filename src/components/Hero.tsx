  ...
  return (
    <section className="relative min-h-[500px] flex items-center justify-center overflow-hidden bg-grass-gradient">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="w-8 h-8 bg-minecraft-gold absolute top-20 left-10 animate-block-bounce" style={{ animationDelay: '0s' }}></div>
        <div className="w-6 h-6 bg-minecraft-diamond absolute top-32 right-20 animate-block-bounce" style={{ animationDelay: '0.5s' }}></div>
        <div className="w-10 h-10 bg-minecraft-stone absolute bottom-20 left-20 animate-block-bounce" style={{ animationDelay: '1s' }}></div>
        <div className="w-4 h-4 bg-minecraft-redstone absolute top-40 left-1/2 animate-block-bounce" style={{ animationDelay: '1.5s' }}></div>
      </div>

      {/* Content */}
      <div className="relative z-10 text-center max-w-4xl mx-auto px-4">
        <h1 className="text-5xl md:text-7xl font-bold text-primary-foreground mb-6 font-minecraft">
          Craft Your
          <span className="block text-minecraft-diamond">Adventure</span>
        </h1>
        
        <p className="text-xl md:text-2xl text-primary-foreground/90 mb-8 font-minecraft">
        ...
        <div className="grid grid-cols-3 gap-8 mt-12 max-w-md mx-auto">
          ...
          <div className="text-center">
            <div className="text-3xl font-bold text-minecraft-diamond font-minecraft">50K+</div>
