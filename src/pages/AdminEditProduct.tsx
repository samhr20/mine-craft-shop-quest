...
const AdminEditProduct: React.FC = () => {
  ...
  useEffect(() => {
    if (isAdmin && hasPermission('products') && id) {
      loadProduct();
      loadCategories();
    }
  }, [isAdmin, hasPermission, id]);
        ...
        <Card className="bg-white/95 backdrop-blur-xl border-2 border-minecraft-grass/50 shadow-xl">
          <CardHeader>
            ...
            <CardDescription className="font-minecraft">
              Update the details for your Minecraft product
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {/* Product Info */}
              <div className="bg-muted/20 p-4 rounded-lg border border-minecraft-stone/20">
                <h4 className="font-minecraft font-semibold text-gray-800 mb-2">Product Details</h4>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                  <div>
                    <span className="font-minecraft text-muted-foreground">Created:</span>
                    <span className="font-minecraft text-gray-800 ml-2">
                      {new Date(product.created_at).toLocaleDateString()}
                    </span>
                  </div>
                  <div>
                    <span className="font-minecraft text-muted-foreground">Last Updated:</span>
                    <span className="font-minecraft text-gray-800 ml-2">
